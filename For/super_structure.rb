...
module Scene
	...
	class Opening
		def start
			...
			sleep(2)
			Display::GameMessage.output(:white, "彼自身は、派遣なのでソースコードを持ち帰ることができない")
			sleep(2)
			Display::GameMessage.output(:white, "また彼自身が、作品名を名乗ることもない")
			sleep(2)
			Display::GameMessage.output(:white, "彼が、傷痕を残すためにやっているのが")
			sleep(2)
			Display::GameMessage.output(:white, "技術スタックでの勝手に同人開発である")
			sleep(2)
			Display::GameMessage.output(:white, "")
			sleep(2)
			Display::GameMessage.output(:white, "")
